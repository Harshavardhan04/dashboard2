...
// // //   const getCurrencyColor = useCallback((currency) => {
// // //     switch (currency) {
// // //       case "AUD":
// // //         return "#FFD700";
// // //       case "EUR":
...
// // //   }, [selectedCurrencies, filteredData, getCurrencyColor, compareWithTarget, totalLine, shadeData]);
...
// // //   const handleTooltipFormatter = useCallback(function () {
...
// // //       },
// // //     },
// // //   }), [isDarkMode, startDate, endDate, handleTooltipFormatter, getData]);
...
// // //       });
// // //     }
// // //   }, [startDate, endDate, selectedCurrencies, compareWithTarget, loading, data, isDarkMode, getData]);
...
// // //                 <span>Total:{formatNumber(parseFloat(summary.split('Total: ')[1]?.split('<br>')[0]))}</span>
// // //                 <span>Target:{formatNumber(parseFloat(summary.split('Target: ')[1]?.split('<br>')[0]))}</span>
// // //                 <span>Difference:{formatNumber(parseFloat(summary.split('Difference: ')[1]?.split('<br>')[0]))}</span>
// // //                 <span
...
// //     ];
// //     return compareWithTarget ? compareData : compareData.slice(0, -1);
// //   }, [compareWithTarget, filteredData, selectedCurrencies]);
...
// //     if (targetValue !== null && totalValue !== null) {
// //       const difference = formatNumber((totalValue - targetValue).toFixed(2));
// //       const totalBreakdown = selectedCurrencies
// //         .map((currency) => {
// //           const point = points.find((p) => p.series.name === currency.value);
// //           return point
...
// //                   color: 'var(--text-color)',
// //                   backgroundColor: 'var(--input-bg-color)',
// //                   borderRight: '1px solid var(--control-bg-color)',
// //                 },
// //               },
// //             }}
// //           />
...
//   const customMultiValueContainer = ({ getValue, children, ...props }) => {
//     const displayCurrencies = getValue();
//     const toDisplay = displayCurrencies.slice(0, 5);
//     const remaining = displayCurrencies.length - toDisplay.length;
  
//     return (
//       <div>
//         {toDisplay.map((val, index) => (
//           <div key={index}>{val.label}</div>
//         ))}
