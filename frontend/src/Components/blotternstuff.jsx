  ...
  return (
    <Box display="flex" flexDirection="column" height="100vh" width="100vw">
      <Box display="flex" flexDirection="row" width="100%" height="calc(100vh - 50px)" paddingTop="20px" marginTop="60px" boxSizing="border-box">
        {showTable && (
          <Box flex="7" height="calc(100vh - 100px)" overflow="auto" paddingRight="10px" boxSizing="border-box">
            <TradeTable />
          </Box>
        )}
        {showForm && (
          <Box flex="3" height="calc(100vh - 100px)" overflow="auto" padding="16px" boxSizing="border-box" margin="auto">
            <TradeForm
