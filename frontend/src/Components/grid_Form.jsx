...
const rows = [
  { id: 1, entryDate: '2024-06-25', trader: 'negusha', tradeSubType: 'Callable CLN', underlying: 'AvivaPlcSub', currency: 'GBP', strategy: 'NIF TBD GBP', notional: 100000000, maturityDate: '2029-07-10', requestType: 'RFQ', client: 'CAT' }
];
